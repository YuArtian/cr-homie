...
1. **Linter-catchable issues** — missing semicolons, unused imports, formatting, basic type errors that ESLint/Prettier/tsc/ruff/golangci-lint already flag
...
- ❌ Add findings about unchanged code (exception: `project` scope mode)
